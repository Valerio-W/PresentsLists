			    ...
			    <% for (Present present : presents_list.getPresents()) { %>
			         <tr>
	                   ...
	                   <% if (present.getImage() != null) { %>
	                	...
	                	<%if(present.getState().equalsIgnoreCase("ordered") && present.getPayments().size()==0 && presents_list.getOwner().getId()== u.getId()){ %>
	                	...
	                	<%} %>
	                	<%if((present.getState().equalsIgnoreCase("reserved") || present.getPayments().size()>=0) && presents_list.isOwnerOrGuest(u)){ %>
